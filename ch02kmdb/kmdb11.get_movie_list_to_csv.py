...
service_key = '17dfd466a09d5f9fccd59185d02c2231'
...
for thisYear in range(startYear, endYear):
    ...
    while True :
        ...
        try:
            ...
            if pageNumber == totalPage : # 1페이지일 때만 전체 개수를 출력합니다.
...
filename = 'kmdb11.get_movie_list_to_csv'
